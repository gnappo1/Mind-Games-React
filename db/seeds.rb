...
#Quiz.create([{ name: 'Logic I', total_time: 0 }, { name: 'World Capitals', total_time: 0, category: "Geography" }, { name: 'American History', total_time: 0, category: "History" }, { name: 'I', total_time: 0, category: "General Knowledge" }])
...
#  {text: "Your parents give you $1024 for your birthday. Every day you spend half of what you own. After how many days you won't even find $1 in your wallet?", quiz_id: 1, answer: "12", points: 7, time: 0},
#  {text: "Place the numbers 1-9 in a 3 by 3 grid, one number per box, so that the vertical, horizontal, and diagonal sums are all 15. Write the solution with the sequence of numbers without spaces (e.g. 734165289 )following the order that you see in the picture.", image_url: "http://www.computing.northampton.ac.uk/~anastas/images/Mathematics/MagicSquares/Figure%20(I).png",  quiz_id: 1, answer: "276951438", points: 7, time: 0},
